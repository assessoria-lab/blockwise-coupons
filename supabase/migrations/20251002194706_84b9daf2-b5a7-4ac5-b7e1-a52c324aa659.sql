-- Adicionar de volta a coluna lojista_id na tabela logs_sistema
ALTER TABLE public.logs_sistema 
ADD COLUMN IF NOT EXISTS lojista_id UUID REFERENCES public.lojistas(id) ON DELETE SET NULL;

-- Atualizar a função log_acao_admin para preencher lojista_id quando aplicável
