...
export default function CadastroLojista() {
  ...
  return (
    <AdminLayout currentPage="lojistas" onNavigate={handleNavigation}>
      <div className="max-w-2xl mx-auto">
        ...
        <div className="sticky bottom-0 bg-white border-t border-border mt-6 p-4 sm:relative sm:bg-transparent sm:border-none sm:mt-6 sm:p-0">
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            ...
            >
              {salvarLojistaMutation.isPending ? (
                <>
